...
message("-- Creating and partition boot image")
execute_process(
...
message("-- Copying boot files")

execute_process(
    COMMAND mmd -i ${GPT_IMAGE}@@32K ::EFI
    COMMAND mmd -i ${GPT_IMAGE}@@32K ::EFI/BOOT
    COMMAND mcopy -i ${GPT_IMAGE}@@32K ${CMAKE_BINARY_DIR}/BOOTaa64.EFI ::EFI/BOOT/BOOTaa64.EFI
    OUTPUT_QUIET
    ERROR_QUIET
)
